...
class KVCacheManager:
    ...
    def _get_partial_reuse_lookup_block_hashes(
        ...
        if effective_decision != "partial_reuse":
            return request.block_hashes
    ...
    def allocate_slots(
        ...
        num_tokens_to_cache = self._get_cacheable_num_tokens(
            request,
            num_tokens_to_cache,
        )
