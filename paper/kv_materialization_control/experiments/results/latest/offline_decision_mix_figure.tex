...
\begin{tikzpicture}
\begin{axis}[
xbar, bar width=5pt, width=0.80\columnwidth, height=0.23\textheight,
xmin=0, xmax=100, xlabel={Requests selecting partial reuse (\%)},
...
ytick=data, yticklabel style={font=\tiny}, xtick={0,25,50,75,100},
...
\end{axis}
\end{tikzpicture}
\caption{The eight workload cases in which the historical offline oracle selects partial reuse at least once. Partial reuse is concentrated rather than universal; the heuristic also over-selects it in several cases.}
