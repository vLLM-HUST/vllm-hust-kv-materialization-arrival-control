...
Figure~\ref{fig:offline-decision-mix} uses the workload-family labels preserved
by the historical offline artifact. The figure is retained as historical
decision-study evidence and is not promoted to a new run.
