...
def test_compute_runtime_control_realigns_partial_to_full_without_block_support(monkeypatch) -> None:
    monkeypatch.delenv("VLLM_KV_MATERIALIZATION_LOG_PATH", raising=False)
    ...
    assert observation.runtime_target_tail_tokens == 1600 - observation.reusable_prefix_tokens
    ...
    assert runtime_hint["target_tail_tokens"] == 1600 - observation.reusable_prefix_tokens
